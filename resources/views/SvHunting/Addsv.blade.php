  ...
  <div class="content">
    <div class="container">
      <table style="width:100%">
        <tr>
         	<center>
			 <h1 style="text-align: center;">ADD Supervisor FORM</h1>
        </br>
		<button <a href="">Add Supervisor</a></button>
        <button <a href="" target="_blank">View supervisor list </a></button>
        <button <a href="" target="_blank">Edit supervisor list </a></button>
	...
	<center><fieldset>
			...
			<table>
				<form action="Addsupervisor" method="POST" name="addsupervisorForm"  >
                @csrf
				<center>
				<td><td>
					<p>
					<td>
					<label for="id">Sv ID:</label>
					</td>
					<td>
...
>>>>>>> c3e81b7b21a94424e4c3e4d6a92982636a78dd56
>>>>>>> Stashed changes
<x-footer-new />